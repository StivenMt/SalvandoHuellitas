...
if (formAgregarMascota) {
  formAgregarMascota.onsubmit = function (e) {
    ...
    let modal = document.getElementById("modal-mascota-agregada");
    let mensaje = "La mascota " + newPet.name + " ha sido registrada exitosamente y ya está disponible para adopción.";
    document.getElementById("mascota-agregada-mensaje").innerText = mensaje;
    modal.classList.remove("ocultador");
...
// Cerrar modal de mascota agregada
let btnCerrarModalMascota = document.getElementById("btn-cerrar-modal-mascota");
if (btnCerrarModalMascota) {
  btnCerrarModalMascota.onclick = function () {
    document.getElementById("modal-mascota-agregada").classList.add("ocultador");
  };
}
